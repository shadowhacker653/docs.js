...
Asena.addCommand({pattern: 'xmedia', fromMe: false, desc: Lang.XMEDİA_DESC}, (async (message, match) => {    
    ...
    await message.sendMessage('❄️ *Command*: *.mp4enhance*\n💌 *Discription*: Enhance video’s quality.\n\n❄️ *Command*: *.interp*\n💌 *Discription*: Increases the FPS of the video.\n\n❄️ *Command*: *.mp4slowmo*\n💌 *Discription*: Applies true-slowmo to non-slow motion videos.\n\n❄️ *Command*: *.x4mp4*\n💌 *Discription*: Reduce video’s quality by 75%.\n\n❄️ *Command*: *.x2mp4*\n💌 *Discription*: Reduce video’s quality by 50%.\n\n❄️ *Command*: *.gif*\n💌 *Discription*: Converts video to gif.\n\n❄️ *Command*: *.agif*\n💌 *Discription*: Converts video to voiced gif.\n\n❄️ *Command*: *.mp4blur*\n💌 *Discription*: Blurs the background of the video.\n\n❄️ *Command*: *.mp4stab*\n💌 *Discription*: Decreases the vibration of the video.\n\n❄️ *Command*: *.mp4rainbow*\n💌 *Discription*: Applies a rainbow effect to video.\n\n❄️ *Command*: *.mp4color*\n💌 *Discription*: Makes the colors of the video more vivid and beautiful.\n\n❄️ *Command*: *.mp4art*\n💌 *Discription*: Applies a art effect to the video.\n\n❄️ *Command*: *.mp4negative*\n💌 *Discription*: Applies a negative color filter to the video.\n\n❄️ *Command*: *.mp4vintage*\n💌 *Discription*: Applies a nostalgic effect to video.\n\n❄️ *Command*: *.mp4bw*\n💌 *Discription*: Applies a monochrome effect to video.\n\n❄️ *Command*: *.mp4reverse*\n💌 *Discription*: Plays the video in reverse.\n\n❄️ *Command*: *.mp4edge*\n💌 *Discription*: Applies a edge effect to the video.\n\n❄️ *Command*: *.mp4image*\n💌 *Discription*: Converts photo to 5 sec video.\n\n❄️ *Command*: *.spectrum*\n💌 *Discription*: Converts the spectrum of sound into video.\n\n❄️ *Command*: *.waves*\n💌 *Discription*: Converts the wave range of sound to video.\n\n❄️ *Command*: *.frequency*\n💌 *Discription*: Converts the frequency range of sound to video.\n\n❄️ *Command*: *.avec*\n💌 *Discription*: Converts the histogram of sound to video.\n\n❄️ *Command*: *.volumeaudio*\n💌 *Discription*: Converts the decibel value of the sound into video.\n\n❄️ *Command*: *.cqtaudio*\n💌 *Discription*: Converts the CQT value of audio to video.\n\n❄️ *Command*: *.mp3eq*\n💌 *Discription*: Adjusts the sound to a crystal clear level.\n\n❄️ *Command*: *.mp3crusher*\n💌 *Discription*: Distorts the sound, makes ridiculous.\n\n❄️ *Command*: *.mp3reverse*\n💌 *Discription*: Plays the sound in reverse.\n\n❄️ *Command*: *.mp3pitch*\n💌 *Discription*: Makes the sound thinner and faster.\n\n❄️ *Command* *.mp3low*\n💌 *Discription*: Makes the sound deep and slower.\n\n❄️ *Command*: *.x2mp3*\n💌 *Discription*: Makes the sound twice as fast.\n\n❄️ *Command*: *.mp3volume*\n💌 *Discription*: Increase sound level so much.\n\n❄️ *Command*: *.bwimage*\n💌 *Discription*: Applies a monochrome effect to image.\n\n❄️ *Command*: *.vintageimage*\n💌 *Discription*: Applies a vinatge effect to video.\n\n❄️ *Command*: *.edgeimage*\n💌 *Discription*: Applies a edge effect to the photo.\n\n❄️ *Command*: *.enhanceimage*\n💌 *Discription*: Makes the photo clearer.\n\n❄️ *Command*: *.blurimage*\n💌 *Discription*: Blurs the background of the photo.\n\n❄️ *Command*: *.grenimage*\n💌 *Discription*: Applies grain effect to the photo.\n\n❄️ *Command*: *.negativeimage*\n💌 *Discription*: Applies a negative color filter to the photo.\n\n❄️ *Command*: *.rainbowimage*\n💌 *Discription*: Applies rainbow effect to the photo.\n\n❄️ *Command*: *.colorimage*\n💌 *Discription*: It makes the colors of the photo more vivid and attractive.\n\n❄️ *Command*: *.artimage*\n💌 *Discription*: Applies a art effect to the photo.');

}));

Asena.addCommand({pattern: 'x4mp4', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('**🐿️ Please send a video**');
    var downloading = await message.client.sendMessage(message.jid,'*🐥 Editing please wait*',MessageType.text);
...
Asena.addCommand({pattern: 'mp4image', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    var downloading = await message.client.sendMessage(message.jid,'*🐥 Converting please wait*',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'mp4slowmo', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('**🐿️ Please send a video**');
    var downloading = await message.client.sendMessage(message.jid,'*🕺 Adding Slow motion.....*',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
